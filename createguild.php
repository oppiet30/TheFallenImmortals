...

{
	...
	$getguild = mysqli_query($login, "SELECT * FROM guilds WHERE name='".$guildname."'");
...

	{
...

		{
...

			{
				...
				$setchar = mysqli_query($login, "UPDATE characters SET guild='".$guildname."', gold='".$newgold."' WHERE id='".$_SESSION['userid']."'");

				$setguild = mysqli_query($login, "INSERT INTO guilds (`name`, `tag`, `leader`, `news`) VALUES ('".$guildname."', '".$guildtag."', '".$char['username']."', '".$news."')");
