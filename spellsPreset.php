...
if($_POST['action'] == "use"){
	...
	if(in_array("Not Set", explode(", ", $char['presets']))){
		...
		if($preset[0] == "None"){
			...
			$one = $preset[0];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['0']."'");
		...
		if($preset[1] == "None"){
			...
			$two = $preset[1];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['1']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[2] == "None"){
			...
			$three = $preset[2];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['2']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[3] == "None"){
			...
			$four = $preset[3];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['3']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[4] == "None"){
			...
			$five = $preset[4];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['4']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[5] == "None"){
			...
			$six = $preset[5];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['5']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[6] == "None"){
			...
			$seven = $preset[6];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['6']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[7] == "None"){
			...
			$eight = $preset[7];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['7']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($preset[8] == "None"){
			...
			$nine = $preset[8];
			$findCostSQL = mysqli_query($login, "SELECT * FROM affinity WHERE name='".$preset['8']."'");
			$foundcost = mysqli_fetch_assoc($findCostSQL);
			$spellLevel = $foundcost['level'];
			if($spellLevel == "0"){ $totalcost += '0'; }
			if($spellLevel == "1"){ $totalcost += '1000'; }
		...
		if($char['mana'] >= $totalcost){
			$updateblessings = mysqli_query($login, "UPDATE characters SET blessing='".$preset."', mana=mana-'".$totalcost."' WHERE username='".$char['username']."'");
	...
	$updateCharacterPresets = mysqli_query($login, "UPDATE characters SET presets='".$presetSet."' WHERE username='".$char['username']."'");
