...

{
    ...
    $getemail = mysqli_query("SELECT * FROM characters WHERE email='".$_POST['userEmail']."'");
...

{
    ...
    $getcomrade = mysqli_query("SELECT * FROM characters WHERE username='".$comrade."'");
...

{
    ...
    $makeSecondClass = mysqli_query("INSERT INTO secondclass (`username`, `class`, `level`, `expacq`, `expreq`, `blood`) VALUES ('".$username."', '".$secondClass."', '1', '0', '15', '0')");

    $createuser = mysqli_query("INSERT INTO characters (`username`, `password`, `email`, `gender`, `class`, `life`, `mana`, `strength`, `dexterity`, `endurance`, `intelligence`, `concentration`, `ip`, `refferal`) VALUES ('".$username."', '".$password."', '".$email."', '".$gender."', '".$class."', '".$end."', '".$int."', '".$str."', '".$dex."', '".$end."', '".$int."', '".$con."', '".$_SERVER['REMOTE_ADDR']."', '".$comrade."')");

    $createkey = mysqli_query("INSERT INTO activation (`username`, `key`) VALUES ('".$username."', '".$key."')");

    $createwarn = mysqli_query("INSERT INTO warnings (`username`) VALUES ('".$username."')");
    ...
    $query = mysqli_query("INSERT INTO chatroom (`date`, `userlevel`, `message`, `to`) VALUES ('".$date."', '2', '".$messageChat."', 'Mod')") or die(mysqli_error());
