...
$query = mysqli_query($conn, "DELETE FROM banned WHERE ip='67.183.247.88'") or die(mysqli_error());
...
if($char['userlevel'] == "1")
{
	$showtables = mysqli_query($conn, "SHOW TABLES FROM forsake1_ic") or die(mysqli_error());
