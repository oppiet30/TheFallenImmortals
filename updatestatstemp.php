...
include('db.php');
$time = time();
$setactive = mysqli_query($login, "UPDATE characters SET lastactive='".$time."' WHERE id='".$_SESSION['userid']."'");
...
$getequip = mysqli_query($login, "SELECT * FROM inventory WHERE username='".$charname."' AND equipped='Yes'");
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Might'"); 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Might II'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Might III'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Might IV'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Might V'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Speed'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Speed II'")or die("alert('Mysql Error!');"); 
    $level = mysqli_fetch_assoc($result)or die("alert('Mysql Error!');"); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Speed III'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Speed IV'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Speed V'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Constitution'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Constitution II'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Constitution III'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Constitution IV'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Constitution V'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Concentration'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Concentration II'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Concentration III'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Concentration IV'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Concentration V'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Intelligence'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Intelligence II'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Intelligence III'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Intelligence IV'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = mysqli_query($login, "SELECT level FROM affinity WHERE name='Intelligence V'"); 
    $level = mysqli_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
$findLogs2 = mysqli_query($login, "SELECT * FROM scavenger WHERE username='".$char['username']."'");
...
$grabBag = mysqli_query($login, "SELECT * FROM `bagdrop` WHERE (`posx` BETWEEN ".$xbottom." AND ".$xtop.") AND (`posy` BETWEEN ".$ybottom." AND ".$ytop.")");
$bag = mysqli_fetch_assoc($grabBag);
$there = mysqli_num_rows($grabBag);
if($there > "0"){
	$scavenge .= "-There is a bag at ".$bag['posx'].", ".$bag['posy']."<br />";
}
$findOre = mysqli_query($login, "SELECT * FROM ore WHERE (`xpos` BETWEEN ".$xbottom." AND ".$xtop.") AND (`ypos` BETWEEN ".$ybottom." AND ".$ytop.")");
...
$blessing1 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[0]."'"));
$blessing2 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[1]."'"));
$blessing3 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[2]."'"));
$blessing4 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[3]."'"));
$blessing5 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[4]."'"));
$blessing6 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[5]."'"));
$blessing7 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[6]."'"));
$blessing8 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[7]."'"));
$blessing9 = mysqli_fetch_assoc(mysqli_query($login, "SELECT * FROM affinity WHERE name='".$blessing[8]."'"));
