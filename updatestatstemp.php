...
$getequip = db_query("SELECT * FROM inventory WHERE username=? AND equipped='Yes'", [$charname]);
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Might'"); 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Might II'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Might III'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Might IV'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Might V'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Speed'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Speed II'"); 
    $level = db_fetch_assoc($result)or die("alert('Mysql Error!');"); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Speed III'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Speed IV'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Speed V'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Concentration'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Concentration II'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Concentration III'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Concentration IV'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Concentration V'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Intelligence'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Intelligence II'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Intelligence III'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Intelligence IV'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
{ 
    $result = db_query("SELECT level FROM affinity WHERE name='Intelligence V'"); 
    $level = db_fetch_assoc($result); 
    $foo = 0; 
    for($i = 0, $count = count($blessingStats); $i < $count; $i++) 
    { 
...
$bar = "<table>";
$bar .= "<tr><td width=\"45\">Health:</td><td width=\"155\"><table border=\'1\' cellpadding=\'0\' width=\'155px\'><tr><td style=\'background-color: #DD0000;\' title=\'".$charlife." / ".$charend." (".$health."%)\'><img src=\'images/greenblock.jpg\' width=\'".$health."%\' height=\'10px\' /></td></tr></table></td></tr>";
$bar .= "<tr><td>Mana:</td><td><table border=\'1\' cellpadding=\'0\' width=\'155px\'><tr><td style=\'background-color: #DD0000;\' title=\'".$charmana." / ".$charint." (".$mana."%)\'><img src=\'images/blueblock.jpg\' width=\'".$mana."%\' height=\'10px\' /></td></tr></table></td></tr>";
$bar .= "<tr><td>Exp:</td><td><table border=\'1\' cellpadding=\'0\' width=\'155px\'><tr><td style=\'background-color: #DD0000;\' title=\'".$char['expacq']." / ".$char['expreq']." (".$exp."%)\'><img src=\'images/yellowblock.jpg\' width=\'".$exp."%\' height=\'10px\' /></td></tr></table></td></tr>";
$bar .= "</table>";
...
$findLogs2 = db_query("SELECT * FROM scavenger WHERE username=?", [$char['username']]);
$findLogs1 = db_num_rows($findLogs2);
if($findLogs1 > 0){
	$scavenge .= "-<p style=\'color: yellow;\'>";
	while($scavenger = db_fetch_assoc($findLogs2)){
...
$blessing1 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[0]]));
$blessing2 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[1]]));
$blessing3 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[2]]));
$blessing4 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[3]]));
$blessing5 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[4]]));
$blessing6 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[5]]));
$blessing7 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[6]]));
$blessing8 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[7]]));
$blessing9 = db_fetch_assoc(db_query("SELECT * FROM affinity WHERE name=?", [$blessing[8]]));
