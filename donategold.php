...
{
    $getguild = mysqli_query($login, "SELECT * FROM guilds WHERE name='".$char['guild']."'");
    ...
    $removegold = mysqli_query($login, "UPDATE characters SET gold='".$newgold."', totaldonations='".$newtd."' WHERE id='".$_SESSION['userid']."'");
    $donategold = mysqli_query($login, "UPDATE guilds SET bank='".$newbank."' WHERE name='".$char['guild']."'");
