...
if($_POST['itemid'] != NULL || $_POST['itemid'] != "" || $_POST['itemid'] != " "){
	...
	$data = "";
	$querty = mysqli_query($login, "SELECT * FROM forge WHERE id='".$_POST['itemid']."' AND username='".$char['username']."'");
