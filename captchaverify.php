...
$char = mysqli_fetch_assoc($getchar);
  ...
  if($char['captcha_time_limit'] != "0" && $char['captcha_time_limit'] < $time){
	...
	$updateTheDumbass = mysqli_query($login, "UPDATE characters SET lastactive='0', status='Suspended', endsuspend='".$timeSuspended."', reason='".$reasonSuspend."', captcha='Inactive', captcha_time_limit='0' WHERE username='".$char['username']."'");
    ...
    // What happens when the CAPTCHA was entered incorrectly
		 ...
		 mysqli_query($login, "UPDATE characters SET gold=gold+'".$gold."', captcha='Inactive', captcha_time_limit='0' WHERE username='".$char['username']."'");
  }
  ?>