...
if($_POST['itemid'] != NULL || $_POST['itemid'] != "" || $_POST['itemid'] != " "){
	...
	$squerty = mysqli_query($login, "SELECT * FROM forge WHERE username='".$char['username']."'");
