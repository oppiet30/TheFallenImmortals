...
$data = "<h3>Contact Us</h3><br /><br />I receive emails via android mobile. You should expect a fast response. If I do not respond fast I am probably at work or asleep. <br />Thanks, Alex!<br /><br /><form>Email: <input id=\'email\' type=\'text\' /><br />Message(include username):<br /><textarea id=\'message\' rows=\'15\' cols=\'40\'></textarea><br /><input type=\'button\' value=\'Send\' onclick=\'contactUs();\' /></form>";
