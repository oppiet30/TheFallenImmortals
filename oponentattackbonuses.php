...
{
	if($blessing[0] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[0]."'"));
...
if($oponent['affinitys'] >= '2'){
	if($blessing[1] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[1]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
{
	if($blessing[2] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[2]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '4'){
	if($blessing[3] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[3]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '5'){
	if($blessing[4] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[4]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '6'){
	if($blessing[5] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[5]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '7'){
	if($blessing[6] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[6]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '8'){
	if($blessing[7] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[7]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
...
if($oponent['affinitys'] >= '9'){
	if($blessing[8] == "Might"){
		$level = mysql_fetch_array(mysqli_query($conn, "SELECT * FROM affinity WHERE name='".$blessing[8]."'"));
		$oponentstr *= ("1" + ($level['level'] / "10"));
	}
