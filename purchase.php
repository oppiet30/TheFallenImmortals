...
$data .= "<tr><td><strong>Asset Bonuses</strong></td><td><strong>Permanent Bonuses</strong></td><td><strong>Temporary Bonuses</strong></td></tr>";
$data .= "<tr><td><a href=\"javascript: runCashOperation(\'FiveMill\');\">+5Million Gold - 1Cash</a></td><td><a href=\"javascript: runCashOperation(\'HalfStatMulti\');\">+0.5 Stat Point Multiplier - 8Cash</a></td><td><a href=\"javascript: runCashOperation(\'OneDemon\');\">1 Random Overlord Demon - 2 Cash(Your Location)</a></td></tr>";
$data .= "<tr><td><a href=\"javascript: runCashOperation(\'ThirtyMill\');\">+30Million Gold - 5Cash</a></td><td><a href=\"javascript: runCashOperation(\'WholeStatMulti\');\">+1 Stat Point Multiplier -15Cash</a></td><td><a href=\"javascript: runCashOperation(\'FifteenBags\');\">15 Bag Drop - 2 Cash</a></td></tr>";
$data .= "<tr><td><a href=\"javascript: runCashOperation(\'EightKBlood\');\">+8k Blood - 1Cash</a></td><td><a href=\"javascript: runCashOperation(\'FiveStatMulti\');\">+5 Stat Point Multiplier - 70Cash</a></td><td><a href=\"javascript: runCashOperation(\'FifteenMinutes\');\">15 Minutes Bonus Time - 1 Cash</a></td></tr>";
$data .= "<tr><td><a href=\"javascript: runCashOperation(\'FiftyKBlood\');\">+50k Blood - 5Cash</a></td><td><a href=\"javascript: runCashOperation(\'OneTradeSkill\');\">+1% Trade Skill -5Cash</a></td><td><a href=\"javascript: runCashOperation(\'HourBonus\');\">60 Minutes Bonus Time - 2 Cash</a></td></tr>";
