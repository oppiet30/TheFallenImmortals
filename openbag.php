...
if($_POST['bagid'] != NULL){
	$findbagid = mysqli_query("SELECT * FROM bagdrop WHERE id='".$_POST['bagid']."'")or die("alert('The bag is gone!');");
	...
	if($bag['name'] == NULL){
		...
		if($rand == "1"){
			...
			$give = mysqli_query("UPDATE characters SET cash=cash+'1' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query("UPDATE characters SET gold=gold+'".$goldrand."' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query("UPDATE characters SET stats=stats+'".$statpointrand."' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query("UPDATE characters SET blood=blood+'".$bloodrand."' WHERE id='".$char['id']."'");
		...
		$deleteBag = mysqli_query("DELETE FROM bagdrop WHERE id='".$_POST['bagid']."'");
	}
}else{
	print("alert('Error.');");
}
