...
if($_POST['bagid'] != NULL){
	$findbagid = mysqli_query($login, "SELECT * FROM bagdrop WHERE id='".$_POST['bagid']."'")or die("alert('The bag is gone!');");
	...
	if($bag['name'] == NULL){
		...
		if($rand == "1"){
			...
			$give = mysqli_query($login, "UPDATE characters SET cash=cash+'1' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query($login, "UPDATE characters SET gold=gold+'".$goldrand."' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query($login, "UPDATE characters SET stats=stats+'".$statpointrand."' WHERE id='".$char['id']."'");
			...
			$give = mysqli_query($login, "UPDATE characters SET blood=blood+'".$bloodrand."' WHERE id='".$char['id']."'");
		...
		$deleteBag = mysqli_query($login, "DELETE FROM bagdrop WHERE id='".$_POST['bagid']."'");
	}
}else{
	print("alert('Error.');");
}
