...

{
...

    {
        ...
        $update = mysqli_query("UPDATE characters SET gold='".$byegold."', temple='1' WHERE id='".$_SESSION['userid']."'");

        $add = $temple['pot'] + $amount;

        $moregold = mysqli_query("UPDATE temple SET pot='".$add."'");

        $addUserToLotto = mysqli_query("INSERT INTO donationpot (`username`) VALUES ('".$char['username']."')")or die("alert('Can't add to dpot, Tell an Admin!');");
        ...
        if($amount >= 250000 || $char['level'] < "250"){
            ...
            $numberBlessings = mysqli_num_rows(mysqli_query("SELECT * FROM `affinity` WHERE name<>'None' AND name<>'Buy'"));             
            ...
            if($random01 == 1 && $char['affinitys'] >= '1'){
                ...
                $name = mysqli_fetch_assoc(mysqli_query("SELECT * FROM affinity WHERE id='".$firstSlot."'"));
            ...
            if($random02 == 1 && $char['affinitys'] >= '2'){
                ...
                $name = mysqli_fetch_assoc(mysqli_query("SELECT * FROM affinity WHERE id='".$secondSlot."'"));
            ...
            if($random03 == 1 && $char['affinitys'] >= '3'){
                ...
                $name = mysqli_fetch_assoc(mysqli_query("SELECT * FROM affinity WHERE id='".$thirdSlot."'"));
            ...
            if($random04 == 1 && $char['affinitys'] >= '4'){
                ...
                $name = mysqli_fetch_assoc(mysqli_query("SELECT * FROM affinity WHERE id='".$fourthSlot."'"));
            ...
            if($random05 == 1 && $char['affinitys'] >= '5'){
                ...
                $name = mysqli_fetch_assoc(mysqli_query("SELECT * FROM affinity WHERE id='".$fifthSlot."'"));
		...
		if($amount >= 5000000){
            ...
            $increaseTradeSkill = mysqli_query("UPDATE characters SET nobility='".$newNp."' WHERE id='".$_SESSION['userid']."'");
...

{
...

    {
		...
		$findDonations = mysqli_query("SELECT * FROM donationpot WHERE username='".$char['username']."'");
