...

{
    ...
    if($cash >= "1"){
        ...
        $update = db_query("UPDATE characters SET cash=?, gold=? WHERE username=?", [$cash, $gold, $charname]);
...

{
    ...
    if($cash >= "1"){
        ...
        $update = db_query("UPDATE characters SET cash=?, stats=? WHERE username=?", [$cash, $stats, $charname]);
...

{
    ...
    if($cash >= "1"){
        ...
        $update = db_query("UPDATE characters SET cash=?, blood=? WHERE username=?", [$cash, $blood, $charname]);
...

{
    ...
    if($cash >= "8" && ($char['statmult'] + "50") <= "1000"){
        ...
        $update = db_query("UPDATE characters SET cash=?, statmult=? WHERE username=?", [$cash, $statmult, $charname]);
...

{
	if($char['foresight'] == 10)
	{
        ...
        $query = db_query("INSERT INTO chatroom (`date`, `userlevel`, `username`, `message`, `to`)VALUES (?, '3', ?, ?, 'Chatroom')", [$date, $char['username'], $cashmessage]);

        $cash = $cash - "10";

        $update = db_query("UPDATE characters SET cash=?, foresight=? WHERE username=?", [$cash, $foresight, $charname]);
...

{
    ...
    if($cash >= "20" && $char['affinitys'] < "9"){
    	...
    	$updateBlessings = db_query("UPDATE characters SET blessing=? WHERE username=?", [$newBlessing, $char['username']]);
        ...
        $update = db_query("UPDATE characters SET cash=?, affinitys=? WHERE username=?", [$cash, $addAffinity, $charname]);
...

{
    ...
    if($cash >= "1"){
        ...
        $update = db_query("UPDATE characters SET cash=?, automax=? WHERE username=?", [$cash, $automax, $charname]);
...

{
    ...
    if($cash >= "5" && $newTradeSkill < "1000"){
        ...
        $update = db_query("UPDATE characters SET cash=?, tradeskill=? WHERE username=?", [$cash, $tradeSkill, $charname]);
...

{
    ...
    if($cash >= "15" && $char['changeusername'] == "0"){
        ...
        $update = db_query("UPDATE characters SET cash=?, changeusername='1' WHERE username=?", [$cash, $charname]);
...

{
    ...
    if($cash >= "2"){
        ...
        $update = db_query("UPDATE characters SET cash=? WHERE username=?", [$cash, $charname]);
...

{
    ...
    if($cash >= "1"){
		...
		$killBonusTime = db_query("UPDATE bonus SET gold='Yes', experience='Yes', experationTime=? WHERE id='1'", [$newExpTime]);
...

{
    ...
    if($cash >= "25" && $char['teleporter'] != "Yes"){
        ...
        $update = db_query("UPDATE characters SET cash=?, teleporter='Yes' WHERE username=?", [$cash, $charname]);
...

{
    ...
    if($cash >= "5" && $char['bankint'] > "0"){
        ...
        $update = db_query("UPDATE characters SET cash=?, bankint=bankint-'1' WHERE username=?", [$cash, $charname]);
