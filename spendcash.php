...

{
    ...
    if($cash >= "1"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', gold='".$gold."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "1"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', stats='".$stats."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "1"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', blood='".$blood."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "8" && ($char['statmult'] + "50") <= "1000"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', statmult='".$statmult."' WHERE username='".$charname."'");
...

{
	if($char['foresight'] == 10)
	{
        ...
        $query = mysqli_query($login, "INSERT INTO chatroom (`date`, `userlevel`, `username`, `message`, `to`)VALUES ('".$date."', '3', '".$char['username']."', '".$cashmessage."', 'Chatroom')") or die(mysqli_error($login));

        $cash = $cash - "10";

        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', foresight='".$foresight."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "20" && $char['affinitys'] < "9"){
    	...
    	$updateBlessings = mysqli_query($login, "UPDATE characters SET blessing='".$newBlessing."' WHERE username='".$char['username']."'")or die("alert('Could not update your blessings! Tell an admin!');");
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', affinitys='".$addAffinity."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "1"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', automax='".$automax."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "5" && $newTradeSkill < "1000"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', tradeskill='".$tradeSkill."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "15" && $char['changeusername'] == "0"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', changeusername='1' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "2"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "1"){
		...
		$killBonusTime = mysqli_query($login, "UPDATE bonus SET gold='Yes', experience='Yes', experationTime='".$newExpTime."' WHERE id='1'");
...

{
    ...
    if($cash >= "25" && $char['teleporter'] != "Yes"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', teleporter='Yes' WHERE username='".$charname."'");
...

{
    ...
    if($cash >= "5" && $char['bankint'] > "0"){
        ...
        $update = mysqli_query($login, "UPDATE characters SET cash='".$cash."', bankint=bankint-'1' WHERE username='".$charname."'");
