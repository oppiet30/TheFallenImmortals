...
$getinv = mysqli_query($login, "SELECT * FROM inventory WHERE username='".$oponentname."' AND equipped='Yes'");
...
{
	$getguild = mysqli_query($login, "SELECT * FROM guilds WHERE name='".$oponentguild."'");
