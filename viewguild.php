...
$getapplication = mysqli_query($login, "SELECT * FROM applications WHERE username='".$charname."'");
...

{
    ...
    $getmembers = mysqli_query($login, "SELECT * FROM characters WHERE guild='".$char['guild']."'");
...

    {
        ...
        if($guild['recruiting'] == "Yes"){
            ...
            if($members >= "10"){
                ...
                $setRecruiting = mysqli_query($login, "UPDATE guilds SET recruiting='No' WHERE name='".$char['guild']."'");
    ...
    $getapplicants = mysqli_query($login, "SELECT * FROM applications WHERE guild='".$guild['name']."'");
    ...
    $getLog = mysqli_query($login, "SELECT * FROM log WHERE name='".$guild['name']."' ORDER BY id DESC LIMIT 10");
...

{
    ...
    $getguilds = mysqli_query($login, "SELECT * FROM guilds WHERE recruiting='Yes'");
