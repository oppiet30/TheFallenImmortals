...
if(isset($_POST['train']) && $_POST['train'] == $char['class'] && $char['class'] == "Fighter")
{
    if($char['gold'] >= "500000" && $char['blood'] >= "5000" && $char['level'] >= "500"){
        ...
        $updatecharacter = mysqli_query("UPDATE characters SET gold='".$newgold."', class='".$newclass."', blood='".$newblood."' WHERE id='".$_SESSION['userid']."'");
    	...
    	$updateclass = mysqli_query("UPDATE characters SET classlevel=classlevel+'1' WHERE id='".$char['id']."'");
    }else{
...
else
{
    ...
    $findOtherClass = mysqli_query("SELECT * FROM secondclass WHERE username='".$char['username']."'");
