...
if($char['life'] <= "0"){
	...
	$updatemonster = mysqli_query($login, "UPDATE characters SET enemylife='0' WHERE id='".$_SESSION['userid']."'");
...
$getSmallDemons = mysqli_query($login, "SELECT * FROM demons WHERE health>'0' AND power='1'");
...
$getBigDemons = mysqli_query($login, "SELECT * FROM demons WHERE health>'0' AND power='2'");
