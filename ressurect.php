...
$getinv = mysqli_query($login, "SELECT * FROM inventory WHERE username='".$charname."' AND endurance>'0' AND equipped='Yes'");
...
if($char['level'] >= "50"){
    ...
    $takeGold = mysqli_query($login, "UPDATE characters SET gold=gold-'".$charend."' WHERE username='".$char['username']."'");
}else{
    $addOn = "";
}
$ressurect = mysqli_query($login, "UPDATE characters SET life='".$charend."', lastactive='".$date."' WHERE id='".$_SESSION['userid']."'");
