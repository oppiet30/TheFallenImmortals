	...
	elseif($name == "First Aid IV")
	{
		if (!in_array('First Aid III', $characterSpells))
		{
			...
			if($char['intelligence'] < 3000 && $char['blood'] < 100000 && $char['gold'] < 75000000){
				...
				$removeFee = mysqli_query($conn, "UPDATE characters SET blood=blood-'100000', gold=gold-'75000000' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "First Aid V")
	{
		if (!in_array('First Aid IV', $characterSpells))
		{
			...
			if($char['intelligence'] < 10000 && $char['blood'] < 250000 && $char['gold'] < 250000000){
				...
				$removeFee = mysqli_query($conn, "UPDATE characters SET blood=blood-'250000', gold=gold-'250000000' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "Might")
	{
		if (in_array('Might', $characterSpells))
		{
			...
			if($char['intelligence'] < 1000 && $char['blood'] < 5000 && $char['gold'] < 1000000){
				...
				$removeFee = mysqli_query($conn, "UPDATE characters SET blood=blood-'5000', gold=gold-'1000000' WHERE id='".$_SESSION['userid']."'");
