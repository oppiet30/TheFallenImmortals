	...
	if($name == "First Aid II")
	{
		if (!in_array('First Aid', $characterSpells))
		{
			...
			if($char['intelligence'] < 300 && $char['blood'] < 15000 && $char['gold'] < 10000000){
				...
				$removeFee = mysqli_query($login, "UPDATE characters SET blood=blood-'15000', gold=gold-'10000000' WHERE id='".$_SESSION['userid']."'");
				...
				$giveSpell = mysqli_query($login, "UPDATE characters SET spells='".$newCharacterSpells."' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "First Aid III")
	{
		if (!in_array('First Aid II', $characterSpells))
		{
			...
			if($char['intelligence'] < 1000 && $char['blood'] < 45000 && $char['gold'] < 30000000){
				...
				$removeFee = mysqli_query($login, "UPDATE characters SET blood=blood-'45000', gold=gold-'30000000' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "First Aid IV")
	{
		if (!in_array('First Aid III', $characterSpells))
		{
			...
			if($char['intelligence'] < 3000 && $char['blood'] < 100000 && $char['gold'] < 75000000){
				...
				$removeFee = mysqli_query($login, "UPDATE characters SET blood=blood-'100000', gold=gold-'75000000' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "First Aid V")
	{
		if (!in_array('First Aid IV', $characterSpells))
		{
			...
			if($char['intelligence'] < 10000 && $char['blood'] < 250000 && $char['gold'] < 250000000){
				...
				$removeFee = mysqli_query($login, "UPDATE characters SET blood=blood-'250000', gold=gold-'250000000' WHERE id='".$_SESSION['userid']."'");
	...
	elseif($name == "Might")
	{
		if (in_array('Might', $characterSpells))
		{
			...
			if($char['intelligence'] < 1000 && $char['blood'] < 5000 && $char['gold'] < 1000000){
				...
				$removeFee = mysqli_query($login, "UPDATE characters SET blood=blood-'5000', gold=gold-'1000000' WHERE id='".$_SESSION['userid']."'");
